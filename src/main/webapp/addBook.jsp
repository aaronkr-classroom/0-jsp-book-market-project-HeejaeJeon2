...
<div class = "row align-items-md-stretch">
	...
	enctype="multipart/form-data">
		<div class = "mb-3 row">
			<lable class = col-sm-2"><fmt:message key="bookId" /></lable>
			<div class="col-sm-3">
		...
		<div class = "mb-3 row">
			<lable class = "col-sm-2"><fmt:message key="author" /></lable>
			<div class = col-sm-3>
				<input type = "text" name = "author" class = "form-control">
			</div>
		</div>
		<div class = "mb-3 row">
			<lable class = "col-sm-2"><fmt:message key="publisher" /></lable>
			<div class = col-sm-3>
				<input type = "text" name = "publisher" class = "form-control">
			</div>
		</div>
		<div class = "mb-3 row">
			<lable class = "col-sm-2"><fmt:message key="releaseDate" /></lable>
			<div class = col-sm-3>
